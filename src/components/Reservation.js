  ...
  return (
    <>
      <ConfirmDialog
        ...
        renderActions={() => (
          <DialogActions>
            <Button arial-label="Pay-later" onClick={handleConfirmCancel}>
              Cash
            </Button>
            <Button arial-label="Pay-now" onClick={handleConfirmSuccess}>
              Credit card
            </Button>
          </DialogActions>
        )}
        renderDialogContent={() => (
          <DialogContentText>
            We are able to provide you online method for payment or cash before
            settling!
          </DialogContentText>
        )}
      />
